...
export const ROLE_NAV_PERMISSIONS: Record<AdminRole, string[] | '*'> = {
  super_admin: '*',
  operator:    ['/admin', '/admin/users', '/admin/kyc', '/admin/transactions', '/admin/transfers', '/admin/bank', '/admin/fraud', '/admin/waitlist', '/admin/cards'],
  treasurer:   ['/admin', '/admin/transactions', '/admin/transfers', '/admin/bank', '/admin/wallets', '/admin/blockchain', '/admin/cards'],
  support:     ['/admin', '/admin/users', '/admin/kyc', '/admin/transactions', '/admin/waitlist'],
}
