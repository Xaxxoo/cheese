...
import { getBillVariations, payBill } from '@/lib/api/bills'
...
// ─────────────────────────────────────────────────────────
type Step = 'provider' | 'details' | 'package' | 'summary' | 'pin' | 'success' | 'error'

const PROVIDERS = [
  { id: 'mtn-data',      label: 'MTN',      color: 'text-yellow-400' },
  { id: 'airtel-data',   label: 'Airtel',   color: 'text-red-400' },
  { id: 'glo-data',      label: 'Glo',      color: 'text-emerald-400' },
  { id: 'etisalat-data', label: '9mobile',  color: 'text-green-400' },
]
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex items-center gap-3 px-4 pt-5 pb-4">
        ...
        <h1 className="text-lg font-semibold text-white">Buy Data</h1>
      </div>
      ...
      <div className="flex-1 px-4">
        ...
        {step === 'package' && (
          <div className="flex flex-col gap-3 mt-2">
            <p className="text-sm text-white/50 mb-2">Select data bundle</p>
        ...
        {step === 'summary' && selectedVariation && (
          <div className="flex flex-col gap-4 mt-2">
            <p className="text-sm text-white/50 mb-1">Confirm your purchase</p>
            <div className="rounded-2xl border border-white/8 bg-white/4 overflow-hidden">
              {[
                ...
                { label: 'Package', value: selectedVariation.name },
        ...
        {step === 'success' && result && (
          <div className="flex flex-col items-center gap-6 mt-8 text-center">
            ...
            <div>
              <p className="text-lg font-semibold text-white">Data Purchased!</p>
              <p className="text-sm text-white/50 mt-1">
                {selectedVariation?.name} to {result.billersCode}
              </p>
            </div>
